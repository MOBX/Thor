...
public abstract class AbstractCodec implements Codec2 {
    ...
    protected Serialization getSerialization(ThorChannel channel) {
        return CodecSupport.getSerialization(channel.getUrl());
    }

    protected static void checkPayload(ThorChannel channel, long size) throws IOException {
    ...
    protected boolean isClientSide(ThorChannel channel) {
    ...
    protected boolean isServerSide(ThorChannel channel) {
