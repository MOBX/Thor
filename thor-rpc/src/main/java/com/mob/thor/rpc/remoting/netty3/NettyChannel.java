...
final class NettyChannel extends AbstractChannel {
    ...
    private NettyChannel(org.jboss.netty.channel.Channel channel, URL url, ThorChannelHandler handler) {
        super(url, handler);
        if (channel == null) {
    ...
    static NettyChannel getOrAddChannel(org.jboss.netty.channel.Channel ch, URL url, ThorChannelHandler handler) {
        if (ch == null) {
            return null;
        }
