...
public final class ReflectUtils {
    ...
    public static final String                           DESC_REGEX                     = "(?:(?:[VZBCDFIJS])|"
                                                                                          + CLASS_DESC + "|"
                                                                                          + ARRAY_DESC + ")";
    ...
    public static boolean isBeanPropertyReadMethod(Method method) {
        return method != null
               ...
               && ((method.getName().startsWith("get") && method.getName().length() > 3) || (method.getName().startsWith("is") && method.getName().length() > 2));
    }
