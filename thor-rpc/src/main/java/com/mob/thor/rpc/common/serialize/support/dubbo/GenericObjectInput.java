...
public class GenericObjectInput extends GenericDataInput implements ObjectInput {
    ...
    public Object readObject() throws IOException {
        ...
        switch (b) {
            ...
            case OBJECT_DESC_ID: {
                ...
                if (desc == null) throw new IOException("Can not find desc id: " + index);
                break;
            }
            default:
    ...
    public Object getRef(int index) throws IOException {
        if (index < 0 || index >= mRefs.size()) return null;

        Object ret = mRefs.get(index);
        if (ret == SKIPPED_OBJECT) throw new IOException("Ref skipped-object.");
        return ret;
    }
