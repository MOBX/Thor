...
import com.mob.thor.rpc.common.utils.Stack;
...
class J2oVisitor implements JSONVisitor {
    ...
    public void arrayBegin() throws ParseException {
        ...
        if (mType.isArray()) mType = mType.getComponentType();
        else if (mType == Object.class || Collection.class.isAssignableFrom(mType)) mType = Object.class;
        else throw new ParseException("Convert error, can not load json array data into class [" + mType.getName()
                                      + "].");
    }
    ...
    public void arrayItem(int index) throws ParseException {
        if (mTypes != null && mStack.size() == index + 1) {
            if (index < mTypes.length) mType = mTypes[index];
            else throw new ParseException("Can not load json array data into [" + name(mTypes) + "].");
        }
    }
    ...
    private static Object toArray(Class<?> c, Stack<Object> list, int len) throws ParseException {
        ...
        if (c == boolean.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Boolean) ret[i] = ((Boolean) o).booleanValue();
            }
            return ret;
        }
        if (c == int.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Number) ret[i] = ((Number) o).intValue();
            }
            return ret;
        }
        if (c == long.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Number) ret[i] = ((Number) o).longValue();
            }
            return ret;
        }
        if (c == float.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Number) ret[i] = ((Number) o).floatValue();
            }
            return ret;
        }
        if (c == double.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Number) ret[i] = ((Number) o).doubleValue();
            }
            return ret;
        }
        if (c == byte.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Number) ret[i] = ((Number) o).byteValue();
            }
            return ret;
        }
        if (c == char.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Character) ret[i] = ((Character) o).charValue();
            }
            return ret;
        }
        if (c == short.class) {
            ...
            for (int i = len - 1; i >= 0; i--) {
                o = list.pop();
                if (o instanceof Number) ret[i] = ((Number) o).shortValue();
            }
            return ret;
        }
