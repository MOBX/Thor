...
import com.mob.thor.rpc.common.serialize.support.nativejava.NativeJavaObjectInput;
...
public class JavaObjectInput extends NativeJavaObjectInput {
    ...
    public byte[] readBytes() throws IOException {
        ...
        if (len > MAX_BYTE_ARRAY_LENGTH) throw new IOException("Byte array length too large. " + len);
