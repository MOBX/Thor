    ...
    public void writeValue(Object obj, JSONWriter jb, boolean writeClass) throws IOException {
        ...
        if (encoder != null) {
            ...
            for (Map.Entry<Object, Object> entry : ((Map<Object, Object>) obj).entrySet()) {
                ...
                else writeValue(value, jb, writeClass);
            }
            jb.objectEnd();
        } else if (Collection.class.isAssignableFrom(c)) {
            jb.arrayBegin();
            for (Object item : (Collection<Object>) obj) {
                if (item == null) jb.valueNull();
                else writeValue(item, jb, writeClass);
            }
            jb.arrayEnd();
        } else {
            jb.objectBegin();
            ...
            for (String pn : pns) {
                ...
                if (value == null || value == obj) jb.valueNull();
                else writeValue(value, jb, writeClass);
            }
            if (writeClass) {
    ...
    static {
        ...
        d = new Decoder() {
            ...
            public Object decode(Object jv) throws IOException {
                ...
                if (jv instanceof Number) return new Date(((Number) jv).longValue());
                return (Date) null;
            }
        };
