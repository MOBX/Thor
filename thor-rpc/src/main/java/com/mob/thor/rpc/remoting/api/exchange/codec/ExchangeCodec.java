package com.mob.thor.rpc.remoting.api.exchange.codec;

import java.io.IOException;
import java.io.InputStream;

import com.mob.thor.rpc.common.io.Bytes;
import com.mob.thor.rpc.common.io.StreamUtils;
...
import com.mob.thor.rpc.remoting.api.telnet.codec.TelnetCodec;
...
public class ExchangeCodec extends TelnetCodec {
    ...
    protected Object decode(ThorChannel channel, ChannelBuffer buffer, int readable, byte[] header) throws IOException {
        // check magic number.
    ...
    protected void encodeRequest(ThorChannel channel, ChannelBuffer buffer, Request req) throws IOException {
    ...
    protected void encodeResponse(ThorChannel channel, ChannelBuffer buffer, Response res) throws IOException {
        try {
            Serialization serialization = getSerialization(channel);
            // header.
            byte[] header = new byte[HEADER_LENGTH];
    ...
    @Override
    protected Object decodeData(ThorChannel channel, ObjectInput in) throws IOException {
        return decodeRequestData(channel, in);
    }

    protected Object decodeEventData(ThorChannel channel, ObjectInput in) throws IOException {
        try {
            return in.readObject();
        } catch (ClassNotFoundException e) {
            throw new IOException(StringUtils.toString("Read object failed.", e));
    ...
    @Deprecated
    protected Object decodeHeartbeatData(ThorChannel channel, ObjectInput in) throws IOException {
        try {
            return in.readObject();
        } catch (ClassNotFoundException e) {
            throw new IOException(StringUtils.toString("Read object failed.", e));
    ...
    protected Object decodeRequestData(ThorChannel channel, ObjectInput in) throws IOException {
        return decodeRequestData(in);
    }

    protected Object decodeResponseData(ThorChannel channel, ObjectInput in) throws IOException {
        return decodeResponseData(in);
    }

    protected Object decodeResponseData(ThorChannel channel, ObjectInput in, Object requestData) throws IOException {
        return decodeResponseData(channel, in);
    }

    @Override
    protected void encodeData(ThorChannel channel, ObjectOutput out, Object data) throws IOException {
        encodeRequestData(channel, out, data);
    }

    private void encodeEventData(ThorChannel channel, ObjectOutput out, Object data) throws IOException {
        encodeEventData(out, data);
    }

    @Deprecated
    protected void encodeHeartbeatData(ThorChannel channel, ObjectOutput out, Object data) throws IOException {
