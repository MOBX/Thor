...
import com.mob.thor.rpc.common.serialize.DataInput;
        ...
        switch (b) {
            case OBJECT_BYTES:
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    } else throw new UTFDataFormatException("Bad utf-8 encoding at " + b1);
                }
                return sb.toString();
            case OBJECT_NULL:
                return null;
    ...
    private long readVarint64() throws IOException {
        ...
        switch (b) {
            ...
            case VARINT40: {
                ...
                if (b5 < 0) return ret | 0xffffff0000000000l;
                return ret;
            }
            case VARINT48: {
                ...
                if (b6 < 0) return ret | 0xffff000000000000l;
                return ret;
            }
            case VARINT56: {
                ...
                long ret = ((long) b1 & 0xff) | (((long) b2 & 0xff) << 8) | (((long) b3 & 0xff) << 16)
                           | (((long) b4 & 0xff) << 24) | (((long) b5 & 0xff) << 32) | (((long) b6 & 0xff) << 40)
                           | (((long) b7 & 0xff) << 48);
                if (b7 < 0) return ret | 0xff00000000000000l;
                return ret;
            }
            case VARINT64: {
                byte b1 = read0(), b2 = read0(), b3 = read0(), b4 = read0();
